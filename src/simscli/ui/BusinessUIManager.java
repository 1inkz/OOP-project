...
public class BusinessUIManager {
        ...
        switch (choice) {
            ...
            case 2:
                if (activeSim.getOwnedHouse() != null) {
                    System.out.println(uiHelper.RED + "You already own a House!" + uiHelper.RESET);
                    break;
                }
            ...
            case 3:
                if (activeSim.getOwnedHotel() != null) {
                    System.out.println(uiHelper.RED + "You already own a Hotel!" + uiHelper.RESET);
                    break;
                }
    ...
    public void showSellAssetMenu() {
        ...
        if (assets.isEmpty()) {
            System.out.println(uiHelper.RED + "No assets to sell!" + uiHelper.RESET);
            return;
        }
